...
## Active Technologies
- Go 1.25 (backend, CGO disabled), JavaScript/Svelte 5 (frontend) + chi (router), modernc.org/sqlite (database driver), bluemonday (HTML sanitizer), TipTap v3 (rich text editor), D3.js (graph visualization), Svelte 5 + Vite (frontend build) (003-pkm-refactor)
...
- Go 1.25 (backend, CGO disabled), JavaScript/Svelte 5 (frontend) + chi v5 (router), modernc.org/sqlite v1.48.2, TipTap v3 (editor), Svelte 5 + Vite (005-document-archiving)
